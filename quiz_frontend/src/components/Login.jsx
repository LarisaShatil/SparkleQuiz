    ...
    <div>
      <div className='border text-white border-b-purple-900 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <input type='checkbox' name='' id='' className='accent-amber-500 w-4 h-4'/>
          <label htmlFor='Remember me' >Remember me</label>
          </div>
          <span className='text-xs text-violet-500'>Forgot Password?</span>
        </div>
          <button type='submit' className='w-full mb-4 text-[18px] mt-6 rounded-full font-bold bg-white text-amber-500 hover:bg-amber-400 hover:text-white py-2 transition-colors duration-300'>Login</button>
          <div className='text-xs'>
            <span >New here?
              <a onClick={handleRegistration} className='ml-4 font-bold text-violet-500 hover:text-amber-500'>Create an account</a>
            </span>
          </div>
          </form>
      </div>
